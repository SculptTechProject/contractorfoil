              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  >
                    ...
                    <p>
                      ContractorFoil started as an idea to solve the challenges
                      in contractor management faced by small businesses.
                    </p>
                  </div>
                </div>
                {/* Prototype */}
                <div className="flex items-center justify-end space-x-6">
                  ...
                  >
                    ...
                    <p>
                      Our initial prototype was built and tested by a small
                      group of users. We received valuable feedback that shaped
                ...
                <div className="flex items-center justify-end space-x-6">
                  ...
                  >
                    ...
                    <p>
                      ...
                      collaboration were added, setting us apart from
                      competitors.
                    </p>
                  </div>
                  <div
          ...
          <div className="relative z-10 grid max-w-6xl grid-cols-1 gap-8 px-4 mx-auto md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="text-gray-600">
                Monitor each contractor's performance, schedule, and tasks to
        ...
        <section className="py-20 text-gray-900 bg-gradient-to-b from-gray-100 to-white">
          ...
          <div className="max-w-3xl px-4 mx-auto space-y-4">
            ...
            >
              ...
              <p className="mt-2 text-gray-700 transition-opacity duration-300 ease-in-out opacity-0 group-open:opacity-100">
                Our route optimization feature uses advanced algorithms to
                suggest the most efficient route for your contractors, saving
                time and fuel costs.
              </p>
            </details>
