...
const Register: React.FC = () => {
    ...
    return (
        <div data-aos="zoom-up" className="register-container bg-gradient-to-r from-blue-500 to-indigo-600">
            <h2 className="pb-8 text-4xl text-white">Register</h2>
            ...
            <form className="register-form" onSubmit={handleRegister}>
                ...
                <button onClick={handleRegister} type="submit" className="text-white" >Register</button>
            </form>
            </div>
            <div className="text-center text-gray-600 register-footer">
                <div className="pt-6">
                    <p className="text-white">
                        ...
                        <a className="transision-all text-sky-400 outline-white hover:text-white" href="/login">Login</a></p>
                </div>
                <div className="pt-2 text-xs text-emerald-900">
                    <a className="transision-all text-sky-400 outline-white hover:text-white" href="/">Home Page</a>
                </div>
            </div>
        </div>
    );
